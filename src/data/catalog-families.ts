...
export const catalogFamilies: CatalogFamily[] = [
  {
    ...
    description: 'Discos de acero inoxidable en espesor 2.0 para otorgar un tacto firme, orientados tanto para pastillas orgánicas como semimetálicas y metálicas. Diámetros disponibles: 140, 160, 180, 203 y 220 mm. Sistemas de fijación en 6 tornillos y Center Lock.',
  ...
  },
  {
    ...
    description: 'Semimetálicas: junto a la resina del ferodo se mezclan metales para otorgar una potencia excepcional y una disipación del calor también muy buena. Metálicas: hechas de metales (cobre/acero), otorgan potencia de frenada en frenadas prolongadas o en situaciones de lluvia, barro y altas temperaturas. Ventiladas o con disipador de calor: pensadas para disipar el calor generado por la fricción al frenar, mediante las aletas que llevan en la parte superior.',
